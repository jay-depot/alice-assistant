...
export const createMoltbookPostTool = (client: MoltbookClient): Tool => ({
  ...
  description:
    'Creates a Moltbook post in a target submolt and automatically completes Moltbook verification when possible.',
...
export const createMoltbookCommentTool = (client: MoltbookClient): Tool => ({
  ...
  availableFor: ['chat', 'voice'],
  description:
    'Creates a Moltbook comment or reply and automatically completes Moltbook verification when possible.',
  systemPromptFragment:
...
export const manageMoltbookSubscriptionTool = (
