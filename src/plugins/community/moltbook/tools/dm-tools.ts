...
export type ScanForDMRequestIDsParameters = Type.Static<
  typeof scanForDMRequestIDsParameters
>;
...
export const scanForMoltbookDMRequestIDsTool = (
  ...
  description:
    'Scan the dashboard and notifications for any possible pending DM request IDs.',
