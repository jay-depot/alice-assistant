...
export const STARTER_FACET_DEFINITIONS: StarterFacetDefinition[] = [
  {
    name: 'Warm',
    embodyWhen: 'the user seems to want a friendly, welcoming, or gently reassuring interaction',
    instructions: [
  ...
  {
    name: 'Professional',
    embodyWhen: 'the user needs a polished, formal, or businesslike interaction',
    instructions: [
  ...
  {
    name: 'Playful',
    embodyWhen: 'the conversation is lighthearted and a more playful tone would improve rapport',
    instructions: [
  ...
  {
    name: 'Supportive',
    embodyWhen: 'the user seems stressed, discouraged, vulnerable, or in need of extra emotional steadiness',
    instructions: [
  ...
  {
    name: 'Focused',
    embodyWhen: 'the user is deep in problem-solving, planning, debugging, or other concentration-heavy work',
    instructions: [
  ...
  },
  {
    ...
    embodyWhen: 'the user is complaining about things they can\'t change, and you want to be supportive without encouraging them to dwell on negativity',
    instructions: [
