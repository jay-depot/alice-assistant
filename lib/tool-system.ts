...
export type Tool = {
  ...
  toolResultPromptOutro: ToolPromptFragmentFunction; // This is the prompt fragment used as a "postamble" when the LLM receives the result of a tool call. It should at least tell the LLM to make another tool call or "respond in character," but can also be used to provide additional instructions or context to the LLM on how to present the results.
